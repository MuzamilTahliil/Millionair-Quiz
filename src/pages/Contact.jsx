    ...
    <div>
      <section className="min-h-screen flex flex-col justify-between">
        ...
        <div className="bg-gradient-to-b from-green-50 to-green-100 min-h-screen flex flex-col justify-between">
          <div className="font-[sans-serif] max-w-6xl mx-auto relative  rounded-lg py-10 mt-32">
            ...
            <div className="lg:col-span-2 bg-[#6d28d9] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
              <h2 className="text-3xl text-white text-center font-bold mb-6">Contact us</h2>
              <form>
                <div className="max-w-md mx-auto space-y-3">
                  <input type='text' placeholder='Name'
                    className="w-full bg-gray-100 rounded-lg py-3 px-6 text-black outline-none" />
                  <input type='email' placeholder='Email'
                    className="w-full bg-gray-100 rounded-lg py-3 px-6 text-black outline-none" />
                  <input type='email' placeholder='Phone No.'
                    className="w-full bg-gray-100 rounded-lg py-3 px-6 text-black outline-none" />
                  <textarea placeholder='Message' rows="6"
                    className="w-full bg-gray-100 rounded-lg px-6 text-black pt-3 outline-none"></textarea>
                  <button type='button'
                    className="text-gray-800 w-full relative bg-yellow-400 hover:bg-yellow-500 font-semibold rounded-lg text-black px-6 py-3 !mt-6">
